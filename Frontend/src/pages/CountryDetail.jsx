  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-12 gap-4">
        <button 
          onClick={() => navigate('/')}
          className="flex items-center hover:bg-blue-200 hover:text-black space-x-3 px-6 py-3 bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 text-gray-800 dark:text-white"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-8">
          <h1 className="text-4xl font-extrabold text-gray-800 ">{country.name.common}</h1>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
            <div className="space-y-3">
              <p className="flex flex-col sm:flex-row sm:items-center text-gray-700 dark:text-gray-300">
                <span className="font-semibold text-gray-900  mr-2">Native Name:</span> 
                <span>{nativeName}</span>
              </p>
              <p className="flex flex-col sm:flex-row sm:items-center text-gray-700 dark:text-gray-300">
                <span className="font-semibold text-gray-900  mr-2">Population:</span> 
                <span>{country.population.toLocaleString()}</span>
              </p>
              <p className="flex flex-col sm:flex-row sm:items-center text-gray-700 dark:text-gray-300">
                <span className="font-semibold text-gray-900  mr-2">Region:</span> 
                <span>{country.region}</span>
              </p>
              <p className="flex flex-col sm:flex-row sm:items-center text-gray-700 dark:text-gray-300">
                <span className="font-semibold text-gray-900  mr-2">Sub Region:</span> 
                <span>{country.subregion || 'N/A'}</span>
              </p>
              <p className="flex flex-col sm:flex-row sm:items-center text-gray-700 dark:text-gray-300">
                <span className="font-semibold text-gray-900  mr-2">Capital:</span> 
            ...
            <div className="space-y-3">
              <p className="flex flex-col sm:flex-row sm:items-center text-gray-700 dark:text-gray-300">
                <span className="font-semibold text-gray-900  mr-2">Top Level Domain:</span> 
                <span>{country.tld?.[0] || 'N/A'}</span>
              </p>
              <p className="flex flex-col sm:flex-row sm:items-center text-gray-700 dark:text-gray-300">
                <span className="font-semibold text-gray-900  mr-2">Currencies:</span> 
                <span>{currencies.length ? currencies.join(', ') : 'N/A'}</span>
              </p>
              <p className="flex flex-col sm:flex-row sm:items-center text-gray-700 dark:text-gray-300">
                <span className="font-semibold text-gray-900  mr-2">Languages:</span> 
          ...
          {borderCountries.length > 0 && (
            <div className="pt-4">
              <h2 className="text-xl font-bold mb-4 text-gray-800 ">Border Countries:</h2>
